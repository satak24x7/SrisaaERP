...
export class ShellComponent implements OnInit, OnDestroy {
  ...
  navItems: NavItem[] = [
    ...
    { label: 'Expenses', icon: 'pi pi-wallet', route: '/expenses' },
    {
      ...
      expanded: false,
      children: [
        { label: 'Material Requests', icon: 'pi pi-list', route: '/procurement/material-requests' },
        { label: 'Purchase Orders', icon: 'pi pi-file', route: '/procurement/purchase-orders' },
        { label: 'Vendors', icon: 'pi pi-building', route: '/procurement/vendors' },
        { label: 'Items', icon: 'pi pi-box', route: '/procurement/items' },
        { label: 'Price Lists', icon: 'pi pi-tags', route: '/procurement/price-lists' },
        { label: 'OEM Catalog', icon: 'pi pi-th-large', route: '/procurement/oem-catalog' },
        { label: 'Quotations', icon: 'pi pi-file-edit', route: '/procurement/quotations' },
        { label: 'Rate Comparison', icon: 'pi pi-chart-bar', route: '/procurement/rate-comparisons' },
        { label: 'GRN / Receipts', icon: 'pi pi-check-circle', route: '/procurement/grns' },
        { label: 'Invoices & Payables', icon: 'pi pi-receipt', route: '/procurement/invoices' },
      ],
    },
    { label: 'Approvals', icon: 'pi pi-check-square', route: '/approvals' },
    { label: 'Administration', icon: 'pi pi-sitemap', route: '/administration' },
    {
      ...
      children: [
        ...
        { label: 'Approval Workflows', icon: 'pi pi-sitemap', route: '/admin/approval-workflows' },
